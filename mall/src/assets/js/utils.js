var Rt, Dt = St(function(t) {
  ...
  m = xt,
    ...
    (b = function(t, e) {
        ...
        for (var n = m.bytesToWords(t), o = 8 * t.length, r = 1732584193, i = -271733879, s = -1732584194, a = 271733878, u = 0; u < n.length; u++)
    ...
    t.exports = function(t, e) {
      ...
      var n = m.wordsToBytes(b(t, e));
      return e && e.asBytes ? n : e && e.asString ? w.bytesToString(n) : m.bytesToHex(n)
    }
}), jt = ["mw-pv", "mw-sign", "mw-did"], It = (m(Nt, Rt = it),
  Nt.prototype.invoke = function(t) {
    Rt.prototype.invoke.call(this, t);
    var e = t.getOuterContext();
    e.statistics.onEnd("DISPATCH");
    var n = e.headers;
    e.isSameDomain() || (n["mw-h5-token"] = r("_mwp_h5_token"),
      n["mw-h5-token-enc"] = r("_mwp_h5_token_enc")),
      n["mw-sign"] = Dt(this.buildQuery(e)),
      t.invokeNext()
  }
  ,
  Nt.prototype.buildQuery = function(t) {
    var e = t.headers
      , n = Object.keys(e).filter(function(t) {
      return 0 === t.indexOf("mw-") && jt.indexOf(t) < 0
    }).sort().map(function(t) {
      return e[t]
    });
    return n.push(t.api),
      n.push(t.version),
      n.push(Dt(t.getDataString())),
      n.push(A.instance().mState.getToken()),
      n.join("&")
  }
  ,
  Nt);
