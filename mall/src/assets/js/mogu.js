Tt = {
  utf8: {
    stringToBytes: function(t) {
      return Tt.bin.stringToBytes(unescape(encodeURIComponent(t)))
    },
    bytesToString: function(t) {
      return decodeURIComponent(escape(Tt.bin.bytesToString(t)))
    }
  },
  bin: {
    stringToBytes: function(t) {
  ...
  , Pt = Tt;
function Ot(t) {
  return null != t && (Et(t) || function(t) {
    return "function" == typeof t.readFloatLE && "function" == typeof t.slice && Et(t.slice(0, 0))
  }(t) || !!t._isBuffer)
}
