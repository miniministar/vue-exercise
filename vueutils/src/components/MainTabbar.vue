<template>
  <tab-bar>
    ...
    <tab-bar-item path="/cart" activeColor="#ff617f">
    ...
    <tab-bar-item path="profile" activeColor="#ff617f">
<!--       build/webpack.base.conf.js 中配置别名，前面加~, 不用使用相对路径-->
...
<script>
  // build/webpack.base.conf.js 中配置别名，不用使用相对路径，
